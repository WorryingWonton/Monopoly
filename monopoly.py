...
class Monopoly:
    ...
    def __init__(self):
        ...
        self.community_deck = CommunityDeck()
        self.turns = 0
    ...
    def consume_held_card(self, active_player, card_face, card_deck):
        card = list(filter(lambda card: card.face == card_face.lower() and card.parent_deck == card_deck.lower(), active_player.hand))
        if len(card) > 1:
            raise Exception(f'Duplicate cards in deck, there are {len(card)} instances of {card[0].face} belonging to the {card[0].parent_deck} deck')
        elif len(card) == 0:
...
class Card:
    def __init__(self, face, action, holdable, passes_go, parent_deck):
        self.face = face
        self.action = action
...
class CommunityDeck(Deck):
    cards = attr.ib(default=[Card(face='Advance to Go', action=advance_to_go, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Bank error in your favor', action=bank_error_in_your_favor, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Doctor\'s fees', action=doctors_fee, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='From sale of stock you get $50', action=from_sale_of_stock_50, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Get out of Jail Free', action=get_out_jail_free, holdable=True, passes_go=False, parent_deck='community'),
                          Card(face='Go to Jail', action=go_to_jail, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Grand Opera Night', action=grand_opera_night, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Holiday', action=holiday_fund_matures, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Income tax refund', action=income_tax_refund, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Life insurance matures', action=life_insurace_matures, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Pay hospital fees', action=pay_hospital_fees, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Pay school fees', action=pay_school_fees, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Receive $25 consultancy fee', action=receive_25_consultancy_fee, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='Your are assessed for street repairs', action=you_are_assessed_for_street_repairs, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='You have won second prize in a beauty contest', action=you_have_won_second_prize_in_a_beauty_contest, holdable=False, passes_go=False, parent_deck='community'),
                          Card(face='You inherit $100', action=you_inherit_100, holdable=False, passes_go=False, parent_deck='community')
                          ])

@attr.s
class ChanceDeck(Deck):
    cards = attr.ib(default=[Card(face='Advance to Go', action=advance_to_go, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Advance to Illinois Ave.', action=advance_to_illinois_ave, holdable=False, passes_go=True, parent_deck='chance'),
                          Card(face='Advance to St. Charles Place', action=advance_to_st_charles_place, holdable=False, passes_go=True, parent_deck='chance'),
                          Card(face='Advance toklen to nearest Utility', action=advance_to_nearest_utility, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Advance token to the nearest Railraod', action=advance_token_to_nearset_railroad, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Bank pays you dividend of $50', action=bank_pays_you_50_dividend, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Get out of Jail Free', action=get_out_jail_free, holdable=True, passes_go=False, parent_deck='chance'),
                          Card(face='Go back 3 Spaces', action=go_back_3_spaces, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Go to Jail', action=go_to_jail, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Make general repairs on all your property', action=make_general_repairs_on_all_property, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Pay poor tax of $15', action=pay_poor_tax, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Take a trip to Reading Railroad', action=take_trip_to_reading_railroad, holdable=False, passes_go=True, parent_deck='chance'),
                          Card(face='Take a walk on the Boardwalk', action=take_a_walk_on_boardwalk, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='You have been elected Chairman of the Board', action=chairman_of_the_board, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='Your building loan matures', action=your_building_loan_matures, holdable=False, passes_go=False, parent_deck='chance'),
                          Card(face='You have won a crossword competition', action=you_have_won_a_crossword_competition, holdable=False, passes_go=False, parent_deck='chance')])
